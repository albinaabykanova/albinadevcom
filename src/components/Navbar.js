    ...
    >
      <Container>
        <Navbar.Brand href="/" className="d-flex">
          <img
            src={
              "https://cdn3d.iconscout.com/3d/premium/thumb/woman-with-hijab-6530590-5823035.png?f=webp"
            }
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className=" ms-auto" defaultActiveKey="#home">
            ...
            <Nav.Item>
              <Link to="/about" onClick={() => updateExpanded(false)}>
                <AiOutlineUser style={{ marginBottom: "2px" }} /> About
              </Link>
            </Nav.Item>

            <Nav.Item>
              <Link to="/project" onClick={() => updateExpanded(false)}>
                <AiOutlineFundProjectionScreen
